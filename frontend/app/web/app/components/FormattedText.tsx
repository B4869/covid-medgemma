...
export const FormattedText: React.FC<FormattedTextProps> = ({ text, className }) => {
    return (
        <div className={`w-full prose prose-slate max-w-none dark:prose-invert prose-p:leading-relaxed prose-pre:p-0 ${className || ''}`}>
                            ...
                            return (
                                <div className="not-prose my-4 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-[#1e1e1e]">
                                    ...
                                    <div className="flex items-center justify-between px-4 py-2 bg-[#2d2d2d] border-b border-gray-700">
                                        <span className="text-xs font-medium text-gray-200 lowercase">
                                            {language}
                                        </span>
